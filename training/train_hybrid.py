...
def main():
    ...
    wandb.init(project='deepfake-detection', config=CONFIG, name='hybrid-efficientnet-fft')
    ...
    for epoch in range(1, CONFIG['num_epochs'] + 1):
        ...
        if epoch % CONFIG['save_every'] == 0:
            ckpt_path = f"{CONFIG['checkpoint_dir']}/hybrid_epoch{epoch}.pt"
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), f"{CONFIG['checkpoint_dir']}/hybrid_best.pt")
